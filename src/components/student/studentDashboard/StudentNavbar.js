  ...
  return (
    <nav className="navbar">
      ...
      <a href="/" className="attendance nav-link">
        <FontAwesomeIcon className="fontawesome" icon={faClipboardCheck} />{" "}
        Attendance
      </a>
      <a href="/" className="timeTable nav-link">
        <FontAwesomeIcon className="fontawesome" icon={faCalendarDays} /> Time
        Table
      </a>
      <a href="/CourseDetails" className="courseDetail nav-link">
        <FontAwesomeIcon className="fontawesome" icon={faList} /> Course Details
      </a>
      <a href="/SemesterResults" className="results nav-link">
        <FontAwesomeIcon className="fontawesome" icon={faClipboard} /> Semester
        Results
      </a>
      <a href="/FacultyPage" className="faculty nav-link">
      ...
      <a href="/EventNotice" className="sub-event nav-link">
        <FontAwesomeIcon className="fontawesome" icon={faAngleRight} /> Upcoming
        Event
      </a>
      <a
        href="/EventRegistration"
        className="sub-event nav-link register-event "
      >
        <FontAwesomeIcon className="fontawesome" icon={faAngleRight} /> Register
        Event
      </a>
    </nav>
  );
